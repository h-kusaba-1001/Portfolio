    ...
    >
        <v-footer dark padless>
            ...
            >
                ...
                <v-card-text
                    class="text-center px-md-16 blue-grey--text text--darken-2"
                >
                    <div class="">
                ...
                <v-card-text class="yellow darken-1 white--text text-center">
                    <div>2021</div>
                    <div>
                        <strong>H.Kusaba's Portfolio</strong> by Hirofumi Kusaba
                    </div>
                </v-card-text>
            </v-card>
        </v-footer>
        ...
        return {
            icons: [
                ...
                },
                {
                    tooltip: "Wantedlyを見る",
                    src:
                        "/img/front/common/Footer/icon/wantedly_mark_white.svg",
